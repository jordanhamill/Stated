...
extension StateTransitionTrigger {
    public func performingSideEffect(_ sideEffect: @escaping (StateMachine, SentInput<Arguments>, StateFrom, StateTo) -> Void) -> StateTransitionTriggerWithSideEffect<Arguments, StateFrom, StateTo> {
...
public func |<ArgumentsForToState, StateFrom, StateTo: State>(
    ...
    sideEffect: @escaping (StateMachine, SentInput<ArgumentsForToState>, StateFrom, StateTo) -> Void)
